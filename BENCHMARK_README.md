...
| Per-GPU BS | 全局 BS | 每步耗时 | Forward+Loss | Backward+Sync | 全局吞吐量 | 单卡吞吐量 | 显存/卡 |
|:----------:|:-------:|:-------:|:-----------:|:-------------:|:---------:|:---------:|:------:|
| 4 | 32 | 74.8 ms | 30.3 ms | 44.1 ms | 427.7 samples/s | 53.5 samples/s | 0.26 GB |
| 8 | 64 | 79.1 ms | 32.7 ms | 46.0 ms | 808.4 samples/s | 101.1 samples/s | 0.43 GB |
| 16 | 128 | 88.9 ms | 36.4 ms | 52.1 ms | 1439.8 samples/s | 180.0 samples/s | 0.78 GB |
| 32 | 256 | 117.5 ms | 49.7 ms | 67.4 ms | 2177.9 samples/s | 272.2 samples/s | 1.47 GB |
| 64 | 512 | 174.5 ms | 72.0 ms | 102.0 ms | 2934.1 samples/s | 366.8 samples/s | 2.87 GB |
| **96** | **768** | **249.3 ms** | **99.8 ms** | **149.1 ms** | **3079.9 samples/s** | **385.0 samples/s** | **4.23 GB** |
| 128 | 1024 | 350.3 ms | 126.4 ms | 223.3 ms | 2923.2 samples/s | 365.4 samples/s | 5.60 GB |
| 160 | 1280 | 430.1 ms | 153.1 ms | 276.5 ms | 2976.3 samples/s | 372.0 samples/s | 6.99 GB |
| 192 | 1536 | 512.5 ms | 182.5 ms | 329.6 ms | 2996.7 samples/s | 374.6 samples/s | 8.36 GB |
| 256 | 2048 | 714.3 ms | 282.7 ms | 430.8 ms | 2867.1 samples/s | 358.4 samples/s | 11.13 GB |
| 384 | 3072 | 1199.3 ms | 492.4 ms | 706.3 ms | 2561.4 samples/s | 320.2 samples/s | 16.61 GB |
| 512 | 4096 | 1662.5 ms | 654.2 ms | 1007.7 ms | 2463.6 samples/s | 308.0 samples/s | 22.17 GB |
...
3. **Backward 增速明显快于 Forward**
   - bs=4: Forward 30 ms, Backward 44 ms（比值 1:1.5）
   - bs=96: Forward 100 ms, Backward 149 ms（比值 1:1.5）
   - bs=512: Forward 654 ms, Backward 1008 ms（比值 1:1.5）
   - 比值基本稳定在 1:1.5，Backward 本身固有开销约为 Forward 的 1.5 倍
